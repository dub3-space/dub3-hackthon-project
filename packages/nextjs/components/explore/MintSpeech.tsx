...
const inputBoxAbi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "address",
        name: "to", //to speakerTokenId cid speakerAddress buyerAddress script
        type: "address",
      },
      {
        internalType: "uint256",
...
export const MintSpeech = () => {
  ...
  const { data, isSuccess, write } = useContractWrite({
    address: ContractsAndAbis.BuyerNFT.address,
    abi: ContractsAndAbis.BuyerNFT.abi,
    functionName: "mint",
  });
  ...
  const handleMint = async () => {
    ...
    write({
      args: [to, 1, cid, "0x1C9E05B29134233e19fbd0FE27400F5FFFc3737e", to, "qualsiasi cosa va bene"],
    });
  };
  ...
  return (
    <div className="p-4">
      <div className="flex flex-col items-center justify-center max-w-sm text-black">
        <p>Mint Your Speech NFT!</p>
        <div className="flex flex-col">
          <button onClick={() => handleMint()} className="bg-blue-500 text-white p-2 rounded">
            Mint The NFT Containing your AI generated speech
          </button>
        </div>
      </div>
    </div>
